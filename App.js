...
import { colors, CLEAR, numFillerLetters } from "./src/Constants";
import { getRandomGreWord, getFillerLetters, shuffleArray } from "./src/Utils";
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.Header}>
				<Text style={styles.titleText}>GRE Scramble</Text>
			</View>
